...
class Net(nn.Module):
    def __init__(self, training):
        ...
        self.stage2 = VNet(training, inchannel=num_organ+1, stage='stage2')

    def forward(self, inputs):
        # 将第一阶段的输入缩小一倍
        inputs_stage1 = F.interpolate(inputs, (16, 64, 64), mode='trilinear')

        outputs_stage1 = self.stage1(inputs_stage1)
        outputs_stage1 = F.interpolate(outputs_stage1, (16, 128, 128), mode='trilinear')
